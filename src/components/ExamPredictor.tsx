...
// Animated collapsible that actually works
          ...
          return (
            ...
            >
              ...
              >
                <div className="flex items-start justify-between gap-3">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span
                      ...
                      style={{ background: s.border + '33', color: s.text }}
                    >
                      {q.difficulty}
                    </span>
                ...
                {q.topic && (
                  <p className="text-xs text-slate-500 mt-1 ml-5">Topic: {q.topic}</p>
                )}
              </button>

              {/* Answer panel — uses Collapsible with real height measurement */}
                  ...
                  {q.options && q.options.length > 0 && (
                    <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                      {q.options.map((opt: string, j: number) => (
                        <div
                          key={j}
                          className="text-xs bg-black/20 rounded-lg p-2 text-slate-300 border border-white/5"
                        >
                          {opt}
                        </div>
                      ))}
