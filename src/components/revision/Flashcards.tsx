...
export default function Flashcards() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="text-slate-400 text-sm mb-6">Paste your notes and AI generates revision materials instantly.</p>
        ...
        {cards.length > 0 && (
          <motion.div initial={{ opacity:0, y:16 }} animate={{ opacity:1, y:0 }}>
            ...
            <div className="flex items-center justify-between mb-4">
              ...
              {mode === 'flashcards' && <p className="text-xs text-slate-500">Click to flip</p>}
            </div>
